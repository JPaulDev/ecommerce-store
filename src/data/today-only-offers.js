...
const todayOnlyOffers = {
  ...
  graphicsCards: [
    ...
    },
    {
      ...
      price: 819.99,
      salePrice: 799.99,
      description: ['1440MHz, 1830MHz Boost', '8704 CUDA Cores', '10GB GDDR6X'],
    },
    {
      sku: 'GFX-GIG-3070',
      stock: 50,
    ...
    },
    {
      ...
      price: 898.99,
      salePrice: 849.99,
      description: ['1440MHz, 1800MHz Boost', '8704 CUDA Cores', '10GB GDDR6X'],
    },
    {
      sku: 'GFX-ZOT-3060',
      stock: 50,
      ...
      price: 435.99,
      salePrice: 409.99,
      description: ['1320MHz, 1837MHz Boost', '3584 CUDA Cores', '12GB GDDR6'],
    },
    {
      sku: 'GFX-MSI-6800XT',
      stock: 50,
